    ...
    <div className="space-y-4 border-b border-border pb-6 last:border-0">
      <div className="flex items-start justify-between gap-4">
        ...
        <a
          ...
          className="shrink-0 rounded-md bg-[rgb(var(--color-accent-green))] px-4 py-2 text-sm font-medium text-foreground transition-colors hover:opacity-90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-foreground/20"
        >
