...
export function QuizQuestion({
    ...
    return (
        <div className={`min-h-[70vh] p-10 lg:p-0 flex flex-col items-center justify-center w-full max-w-full lg:max-w-[600px] ${isSelectQuestion ? "gap-fluid-50" : "gap-[75px]"}`}>
