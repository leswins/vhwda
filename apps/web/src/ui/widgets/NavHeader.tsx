...
function IconButton({
  ...
  return (
    <button
      ...
      aria-label={label}
      onClick={onClick}
      className="inline-flex w-[75px] items-center justify-center text-foreground hover:bg-surface2"
    >
      {children}
    </button>
  )
          ...
          >
            {isChatOpen ? (
              <button
                type="button"
                onClick={() => navigate("/")}
                className="flex h-full items-center gap-[10px] bg-surface px-5 py-5 text-base font-semibold text-foreground hover:bg-surface2"
                style={{
              ...
              <Button
                variant="dark"
                className="h-full rounded-none px-8 text-base font-semibold"
                onClick={() => {
                  navigate("/chat")
                }}
              >
            ...
            <div className="flex items-center gap-[15px] px-[15px] py-[15px]">
              <button
                ...
                className={`flex items-center justify-center ${language === "en"
              ...
              <button
                ...
                className={`flex items-center justify-center ${language === "es"
                  ? "text-base font-bold text-foreground"
                  : "text-base font-medium text-foreground/60 hover:text-foreground"
                  }`}
              >
