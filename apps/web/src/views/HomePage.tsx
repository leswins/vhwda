...
const StepIconQuiz = () => (
  <svg aria-hidden="true" viewBox="0 0 67 67" className="h-[30px] w-[30px] lg:h-[67px] lg:w-[67px]">
...
const ArrowIndicator = () => (
  <div className="relative flex h-full aspect-square items-center justify-center overflow-hidden self-stretch" aria-hidden="true">
    ...
    <svg className="relative z-10 h-[15px] w-[15px] lg:h-[28px] lg:w-[28px] text-foreground transition-colors duration-300 group-hover:text-surface" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
...
const ShortcutIconScale = () => (
  <svg viewBox="0 0 52 50" fill="none" xmlns="http://www.w3.org/2000/svg" className="h-full w-full">
...
export function HomePage() {
    ...
    const observer = new IntersectionObserver(
      (entries) => {
        entries.forEach((entry) => {
          ...
          // Check if card is fully visible (100% intersection)
          if (entry.isIntersecting && entry.intersectionRatio >= 0.99) {
            setVisibleCardId(cardId)
          } else if (visibleCardId === cardId) {
            // If this card was visible but is no longer, clear it
            setVisibleCardId(null)
          }
        })
      },
      {
        root: null,
        threshold: [0.99], // Require 99% visibility
        rootMargin: '0px'
      }
    )
  ...
  }, [data?.featuredCareers, visibleCardId])
  ...
  return (
    <div className="flex flex-col">
      <PageHead
        title="Explore Healthcare Careers in Virginia"
        description="Discover your healthcare career path with VHWDA's comprehensive bilingual career catalog. Explore careers, compare options, take our career quiz, and find training programs and scholarships in Virginia."
        path="/"
      />
      {/* Hero Section */}
      <section className="bg-surface border-b border-foreground">
        <div className="w-full px-0 py-0">
          <div className="grid w-full lg:grid-cols-[55%_45%] lg:items-start">
            <div className="relative flex h-full flex-col px-5 pt-5 pb-[50px] lg:px-fluid-50 lg:pt-fluid-50 lg:pb-fluid-50">
              <div className="max-w-[640px] lg:mx-0 text-left">
                <h1 className="text-h1 text-foreground">{t(language, "home.hero.title")}</h1>
                <p className="mt-[10px] lg:mt-fluid-25 text-body-lg text-onSurfaceSecondary">
                  {t(language, "home.hero.subtitle")}
                </p>
              </div>
              <div className="mt-10 lg:mt-fluid-40 flex flex-row flex-wrap gap-[15px] lg:gap-4 max-w-[640px] lg:mx-0">
                <Button
                  variant="ghost"
                  size="lg"
                  className="!rounded-none !bg-accentPink px-6 py-3 text-body-base text-foreground hover:!bg-accentPink/90 w-auto lg:flex-none"
                ...
                <Button
                  variant="ghost"
                  size="lg"
                  className="!rounded-none !bg-surface2 px-6 py-3 text-body-base text-foreground hover:!bg-surface1 w-auto lg:flex-none"
      ...
      {/* Steps Section */}
      <section className="bg-surface border-b border-foreground">
        <div className="w-full p-5 lg:px-fluid-30 lg:pt-fluid-30 lg:pb-fluid-30">
              ...
              <div key={step.id} className="group w-full">
                <Link to={step.to} className="block w-full">
                  ...
                  <div className="flex w-full items-center gap-fluid-20 py-fluid-20 lg:hidden">
                    <div className="flex h-fluid-40 w-auto items-center justify-center">
                      <span className="text-sub2 text-foreground">{index + 1}</span>
                    </div>
                    <div className="h-fluid-40 w-[0.5px] bg-foreground" aria-hidden="true" />
                    <div className="flex h-[30px] w-[30px] items-center justify-center" aria-hidden="true">
                      {step.icon}
                    </div>
      ...
      <section className="w-full py-0 overflow-hidden border-b border-foreground">
        <div className="w-full px-0 border-b-[0.5px] border-foreground">
          <div className="flex w-full flex-col lg:flex-row items-stretch justify-between gap-0">
            ...
            <div className="flex flex-1 flex-col gap-fluid-15 p-5 lg:p-fluid-50">
          ...
          <div className="h-[0.5px] w-full bg-foreground lg:hidden" aria-hidden="true" />
          {/* Mobile CTAs container */}
          <div className="flex items-center p-5 lg:hidden">
            <Link
              to="/careers"
              className="flex-1 flex items-center justify-center text-body-base font-semibold text-foreground hover:underline"
            >
              <span>{t(language, "home.featuredCareers.ctaExplore")}</span>
            </Link>
            <div className="h-[40px] w-[0.5px] bg-foreground" aria-hidden="true" />
            <Link
              to="/quiz"
              className="flex-1 flex items-center justify-center text-body-base font-semibold text-foreground hover:underline"
            >
        ...
        <div className="flex gap-0 overflow-x-auto snap-x snap-mandatory scrollbar-hide">
          {data?.featuredCareers && data.featuredCareers.length > 0 ? (
            ...
            [1, 2, 3].map((i) => (
              <div
                key={i}
                className="h-[480px] w-[70%] min-w-[70%] lg:w-[30%] lg:min-w-[30%] shrink-0 bg-surface2 border border-foreground animate-pulse"
              />
            ))
          )}
        </div>
      ...
      <section className="w-full bg-surface border-b border-foreground">
        <div className="flex h-fluid-40 lg:h-[100px] w-full items-center p-5 lg:px-fluid-25 border-b border-foreground">
          <div className="lg:hidden w-full">
            <PatternBar iconSize={10} />
          </div>
          <div className="hidden lg:block w-full">
            <PatternBar iconSize={25} />
          </div>
        </div>
        <div className="flex flex-col lg:flex-row w-full items-stretch lg:h-[550px]">
          <div className="relative flex w-full lg:w-1/2 flex-col justify-between overflow-hidden bg-foreground h-[300px] p-10 lg:h-auto lg:p-fluid-50 text-surface">
            ...
            <div className="relative z-10 flex flex-col gap-fluid-15 max-w-[320px] lg:max-w-none">
              <svg width="180" height="32" viewBox="0 0 404 73" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-surface" aria-label="VHWDA">
              ...
              <div className="text-h3 lg:text-h2 !font-medium mt-fluid-10">
                {t(language, "home.quizSection.left.title")}
              </div>
            </div>
            <div className="inline-flex w-fit bg-surface mt-fluid-25">
              <Button
                variant="ghost"
                className="relative z-10 flex w-fit items-center gap-4 overflow-hidden !rounded-none px-8 py-4 text-[14.4px] lg:!text-h4 font-bold text-foreground transition-all duration-[250ms] ease-in-out"
                onClick={() => navigate("/quiz")}
                onMouseEnter={() => {
                  setHasHovered(true)
              ...
              >
                ...
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" className="relative z-10 shrink-0 lg:w-[25px] lg:h-[25px]">
                  <path d="M-4.92305e-07 11.2626L-3.81923e-07 8.73737L15.1515 8.73737L8.20707 1.79293L10 -4.37114e-07L20 10L10 20L8.20707 18.2071L15.1515 11.2626L-4.92305e-07 11.2626Z" fill="currentColor" />
                </svg>
              </Button>
            </div>
          </div>
          <div className="flex w-full lg:w-1/2 flex-col justify-between border-t lg:border-t-0 lg:border-l border-foreground bg-surface text-foreground min-h-[300px] lg:h-auto">
            <div className="flex flex-col gap-fluid-15 p-10 lg:p-fluid-50">
            ...
            <div className="flex items-center gap-3 border-t border-foreground mx-10 pt-[25px] pb-10 lg:mx-fluid-50 lg:px-0 lg:py-fluid-25 text-muted">
              <ClockIcon />
              <span className="text-sm font-medium">{t(language, "home.quizSection.right.estimate")}</span>
            </div>
          </div>
        </div>
        <div className="flex h-fluid-40 lg:h-[100px] w-full items-center p-5 lg:px-fluid-25 border-t border-foreground">
          <div className="lg:hidden w-full">
            <PatternBar iconSize={10} />
          </div>
          <div className="hidden lg:block w-full">
      ...
      <section className="bg-surface">
        <div className="grid w-full lg:grid-cols-[35%_65%] border-foreground">
