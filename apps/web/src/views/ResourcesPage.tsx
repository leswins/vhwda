...
export function ResourcesPage() {
  ...
  const [openSections, setOpenSections] = useState<ResourceSectionId[]>(["schools"])
  useEffect(() => {
  ...
  return (
    <div className="space-y-0">
      <PageHead
        title="Resources & Financial Aid"
        description="Access scholarships, financial aid, professional organizations, and training programs to support your healthcare career journey in Virginia. Find the resources you need to succeed."
        path="/resources"
      />
            ...
            {[
              ...
              return (
                <React.Fragment key={shortcut.id}>
                  ...
                  >
                    <div className={`mr-fluid-20 flex h-[50px] w-[50px] lg:h-[60px] lg:w-[60px] items-center justify-center ${shortcut.bgColor}`}>
